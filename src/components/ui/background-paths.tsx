			...
			<div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
				...
				>
					...
					<motion.p
						...
						className="font-mono text-xl md:text-2xl mb-12 font-medium tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-neutral-800 to-neutral-600 dark:from-neutral-200 dark:to-neutral-400"
					>
						Built for the{" "}
						<span className="font-bold text-primary">next generation</span> of
						Solana,
						<br />
